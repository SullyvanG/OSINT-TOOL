...
mainOption = """
 ...
 [e] Quitter    [h] Aide    [c] Effacer L'Ecran"""


lookupOption = """
 [1] Dox Nom, Prenom          [8] Traceur Mail
 [2] Dox Pseudo               [9] Employés recherche
 [3] Dox Adresse              [10] Recherche Google
 [4] Dox Telephone            [11] Recherche Facebook
 [5] Dox IP                   [12] Info Twitter
 [6] Dox SSID                 [13] Info Instagram
 [7] Dox Email

 [b] Retour Au Menu    [e] Quitter    [h] Aide    [c] Effacer L'Ecran"""
...
profilerOption = """
 ...
 [b] Retour Au Menu    [c] Effacer L'Ecran   [h] Aide
"""
	...
	while True:
		...
		if choix.lower() == 'h':
			...
			while True:
				...
				choix = input("\n Corompus("+Fore.BLUE + "Profiler" + Fore.RESET + ")$ ")
			...
			print(lookupOption)
			while True:
				lookup = input("\n Corompus("+Fore.BLUE+"Dox"+Fore.BLUE + "" + Fore.RESET + ")$ ")
				if lookup == 'h':
					print(helpLookup)
				elif lookup.lower() == '1':
			...
			while True:
				se = input("\n Corompus("+Fore.BLUE+"Autre Outil"+Fore.BLUE + "" + Fore.RESET + ")$ ")
				if se == 'h':
					print(helpOtherTool)
				elif se == "1":
					hashdecrypt()
			...
			while True:
				newCode = input("\n Corompus("+Fore.BLUE+"Pays"+Fore.BLUE + "" + Fore.RESET + ")$ ")
				if newCode == '1':
